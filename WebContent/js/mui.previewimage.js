(function(mui, window) {
	...
	proto.initEvent = function() {
		...
		var laterCloseEvent = function() {
			!laterClose && (laterClose = mui.later(function() {
		...
		this.element.addEventListener('webkitAnimationEnd', function() {
			if (self.element.classList.contains(mui.className('preview-out'))) { //close
				self.element.style.display = 'none';
				self.element.classList.remove(mui.className('preview-out'));
				laterClose = null;
			} else { //open
	...
	proto.open = function(index, group) {
		if (this.element.classList.contains(mui.className('preview-in'))) {
			return;
		}
